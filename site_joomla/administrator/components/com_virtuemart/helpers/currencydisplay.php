...
/**
 *
 * @version $Id: currencydisplay.php 10723 2022-10-24 07:43:37Z Milbo $
 * @package VirtueMart
 * @subpackage classes
 *
 * @author Max Milbers
...
class CurrencyDisplay {
	...
	//Added for proper price format
	public function priceDisplay($price, $currencyId=0, $quantity = 1.0, $inToShopCurrency = false, $nb= -1) {
		$price = $this->roundForDisplay($price, $currencyId, $quantity, $inToShopCurrency, $nb);
		// Use number_format to ensure consistent formatting
		return number_format($price, 2, '.', ',') . ' ' . $this->_symbol;
	}
