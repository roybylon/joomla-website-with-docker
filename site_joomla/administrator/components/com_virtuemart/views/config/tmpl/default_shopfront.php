 ...
 * @version $Id: default_shopfront.php 11050 2024-08-20 16:52:41Z Milbo $
 */
...
, 'customers' => vmText::_('COM_VM_ASK_QUESTION_CUSTOMERS')
    ...
    echo VmHTML::row( 'raw', 'COM_VIRTUEMART_RECCOMEND_UNATUH',
        VmHTML::radioList('recommend_unauth', VmConfig::get('recommend_unauth', 'customers'), $_recommend_unauth));
...
<td>
	...
	<fieldset>
		...
		<table class="admintable">
			...
			echo VmHTML::row('input','COM_VIRTUEMART_ADMIN_CFG_REVIEW_MINIMUM_COMMENT_LENGTH','reviews_minimum_comment_length',VmConfig::get('reviews_minimum_comment_length',2));
			echo VmHTML::row('input','COM_VIRTUEMART_ADMIN_CFG_REVIEW_MAXIMUM_COMMENT_LENGTH','reviews_maximum_comment_length',VmConfig::get('reviews_maximum_comment_length',3800));
