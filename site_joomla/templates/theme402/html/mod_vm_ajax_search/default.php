...
<a style="display:none;"  href="" title="" onclick="javascript: return false;"></a>
	...
	$st = 'style="display: none;"';
		...
		echo '<input class="button" type="submit" value="'.$search.'" name="Search" '.$st.'/>';
