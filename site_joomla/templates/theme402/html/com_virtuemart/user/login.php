...
//$url = $uri->toString(array('path', 'query', 'fragment'));
    ...
    if ($this->order  ) {
	    ...
	    <form action="<?php echo JRoute::_( 'index.php', 1, $this->useSSL); ?>" method="post" name="com-login" >
	    	...
	    	<div class="width35 floatleft" id="com-form-order-number">
	    	...
	    	<div class="width35 floatleft" id="com-form-order-pass">
			...
			<div class="clear"></div>
	    	<div class="width35" id="com-form-order-submit">
...
<?php }   ?>
      ...
      <p class="floatleft width40" id="com-form-login-username">
       ...
       <p class="floatleft width40" id="com-form-login-password">
...
<div class="width100" id="com-form-login-remember">
       <div class="width40 floatleft">
			...
			<label style="float:left;" for="remember"><?php echo $remember_me = JVM_VERSION===1? JText::_('Remember me') : JText::_('JGLOBAL_REMEMBER_ME') ?></label>
