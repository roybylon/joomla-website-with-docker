...
<div class="manufacturer">
	...
	?>
        <span class="bold"><?php echo JText::_('COM_VIRTUEMART_PRODUCT_DETAILS_MANUFACTURER_LBL') ?></span><a class="modal" rel="{handler: 'iframe', size: {x: 350, y: 300}}" href="<?php echo $link ?>"><?php echo $text ?></a>
    <?PHP } ?>
</div>