...
<form method="post" action="<?php echo JRoute::_('index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id='.$this->product->virtuemart_product_id.'&virtuemart_category_id='.$this->product->virtuemart_category_id) ; ?>" name="notifyform" id="notifyform">
	<h2><?php echo JText::_('COM_VIRTUEMART_CART_NOTIFY') ?></h2>
	...
	<div><span class="floatleft"><input type="text" name="notify_email" class="inputbox" value="<?php echo $this->user->email; ?>" /></span>
		 <span class="addtocart-button"><input type="submit" name="notifycustomer"  class="button" value="<?php echo JText::_('COM_VIRTUEMART_CART_NOTIFY') ?>" title="<?php echo JText::_('COM_VIRTUEMART_CART_NOTIFY') ?>" /></span>
	</div>
