...
?>
		...
		<div class="form-field boxIndent">
			...
			<form method="post" class="form-validate" action="<?php echo JRoute::_('index.php') ; ?>" name="askform" id="askform">
				...
				<label><?php echo JText::_('COM_VIRTUEMART_USER_FORM_NAME')  ?> : <br /><input type="text" class="validate[required,minSize[4],maxSize[64]] inputbox marg-top" value="<?php echo $this->user->name ?>" name="name" id="name" size="30"  validation="required name"/></label>
				<br />
				<label><?php echo JText::_('COM_VIRTUEMART_USER_FORM_EMAIL')  ?> : <br /><input type="text" class="validate[required,custom[email]] inputbox marg-top" value="<?php echo $this->user->email ?>" name="email" id="email" size="30"  validation="required email"/></label>
				<br/>
				<label>
					<?php
					...
					?>
					<br />
					<textarea title="<?php echo $ask_comment ?>" class="validate[required,minSize[<?php echo $min ?>],maxSize[<?php echo $max ?>]] field marg-top" id="comment" name="comment" cols="30" rows="10"></textarea>
				</label>
				<div class="submit">
					...
					<div class="width64 floatright right">
